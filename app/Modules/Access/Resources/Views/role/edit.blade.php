...
@section('form_title') update Role @endsection
@section('styles')
...
@section('page_body')
    <form method="post" action="{{route('editRole',$role->id)}}" class="form-horizontal" role="form">
        @include('access::role._form',['submit_button' => 'Update'])
    </form>
@endsection
